...
class MatchesRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function findMatchesForTeams($idTeamA, $idTeamB): ?Matches
    {
        return $this->createQueryBuilder('m')
            ->andWhere('m.team_a_id = :idA')
            ->andWhere('m.team_b_id = :idB')
            ->setParameter('idA', $idTeamA)
            ->setParameter('idB', $idTeamB)
            ->getQuery()
            ->getResult();
    }
